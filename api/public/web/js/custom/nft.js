const tokenContractAddress = '0x3d27C15Dd3FDC1cd983BF5E830C8e3C5c7A0dAE2';
...
async function mintNft(){
  ...
  const account = await requestAccount();
    tokenContract.methods.mint(objectID, gameID, level, attack, defense, heal, mana, owner).send({
        from: account[0],
...
async function changeGameMaster(){
    ...
    const account = await requestAccount();
    tokenContract.methods.burn(userAddress).send({
        from: account[0],
        gasPrice: web3.utils.toHex(web3.utils.toWei('20', 'Gwei')),
      }).on('receipt', (receipt) => {
          console.log(receipt)
